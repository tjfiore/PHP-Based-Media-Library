...
//get 4 random catalog items on start page
...
//get full catalog function
function full_catalog_array($limit=null,$offset=0){
	include("dbConnection.php");
	
	try{
	$sql = "select media_id,title, category,img from Media order by 
	replace(
	replace(
	replace(title,'The ',''),
	'An ',''),
...
//get catalog by category function
...
function single_item_array($id){
	...
	LEFT OUTER JOIN Books ON Media.media_id = Books.media_id WHERE Media.media_id = ?"
						 );
